...
describe("AchievementsCtrl", function() {
	...
	describe("getAchievements", function() {
		...
		beforeEach(function() {
			...
			spyOn(ServerAchievements, 'query');
		});
		...
		it("Should call ServerAchievements.query", inject(function(ServerAchievements) {
			$scope.getAchievements();
			expect(ServerAchievements.query).toHaveBeenCalled();
		}));
	});
